...
export default function FormButton({
  ...
  return (
    <button
      className={cn("flex h-14 items-center justify-center space-x-2 bg-black dark:bg-dark-border rounded-md text-center text-white", className, (!isValid || !isDirty) ? "bg-opacity-50 cursor-default" : "")}
